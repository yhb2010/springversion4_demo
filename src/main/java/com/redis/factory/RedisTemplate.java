...
public class RedisTemplate {
    ...
    public RedisTemplate(RedisPool redisPool, String appName) {
     ...
     */
    public Long setIfNotExists(final String key, final String value) {
        return new RedisExecutor<Long>() {
            @Override
            Long execute(ShardedJedis jedis, String appName) {
     ...
     */
    public Long listPushHeadAndTrim(final String key, final long size,
            final String... values) {
        return new RedisExecutor<Long>() {
            @Override
            Long execute(ShardedJedis jedis, String appName) {
     ...
     */
    public Set<String> revrangeByScoreWithSortedSet(final String key, final double max,
            final double min) {
