...
public class ParseXML {
    ...
    public static Map<String,String> getC3P0Properties(){
        ...
        try {
        	InputStream isrt = ParseXML.class.getResourceAsStream("/config.xml");
            Document document = reader.read(isrt);
            //获取根节点
    ...
    public static void main(String[] args) {
    	Map<String,String> dataSource = ParseXML.getC3P0Properties();
    	System.out.println(dataSource);
    	String sqlmapper = ParseXML.getMapperXML("com.mysqlmybatis.QuestionDao");
