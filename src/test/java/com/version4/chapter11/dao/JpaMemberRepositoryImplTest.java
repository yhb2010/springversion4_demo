...
public class JpaMemberRepositoryImplTest {
	...
	@Autowired
	private JpaMemberRepositoryImpl memberRepository;

	@Test
	public void save() throws DuplicateSpittleException {
		QzMember member = new QzMember();
		member.setUserName("999");
		memberRepository.save(member, "99");
	}

	@Test
	public void findOne(){
		QzMember member = memberRepository.findByUserID(471475);
